...
/************************************************************
 * EJ1a:
 *  offset = es la posicion en memoria del handler
 *  segsel = es el selector para el segmento donde buscar al handler
 *  type = TODO
 *  dpl = determina el nivel de privilegio
 *  present = determina si el segmento de destino esta presente
 ************************************************************/
